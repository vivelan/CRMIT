...
export default class editAttendees extends LightningElement {
  ...
  @api
  openModal() {
    if(this.template.querySelector('c-edit-current-attendees') != null ){
      this.template.querySelector('c-edit-current-attendees').loadData();
    }
    this.isOpen = true;
  ...
  nextPage(){
    this.template.querySelector('c-add-attendees').nextPageHandler();
  ...
  previousHanlder(){
    this.template.querySelector('c-add-attendees').previousPageHandler();
    this.isSelectView = true;
    this.isEditView = false;
  }

  saveRecord(){
    this.template.querySelector('c-add-attendees').addAttendeesToVisitReport();
  }
  ...
  editRecord(){
    this.template.querySelector('c-edit-current-attendees').updateCurrentAttendees();
  }
